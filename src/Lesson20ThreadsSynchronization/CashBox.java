...
public class CashBox {
    ...
    public Receipt payOff(Map<Good, Integer> goods, double moneyFromBuyer) {
        ...
        return new Receipt(++idReceipt, new SimpleDateFormat("dd.M.yyyy HH:mm:ss").format(new Date()),
                casseNo, items, totalSum, round(moneyFromBuyer - totalSum), moneyFromBuyer);
    }
